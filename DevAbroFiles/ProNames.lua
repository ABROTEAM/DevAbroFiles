...
if Manager(msg) then
if DevAbro:get(DevAbro.."Abro:Lock:ProNames"..msg.chat_id_) then
local Txt = text:match("^وضع توحيد (.*)$") or text:match("^ضع توحيد (.*)$")
send(msg.chat_id_, msg.id_,'⌁︙تم تعيين ↫ '..Txt..' كتوحيد للمجموعه')
DevAbro:set(DevAbro.."Abro:ProNames:Txt"..msg.chat_id_,Txt)
else
...
DevAbro:set(DevAbro.."Abro:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAbro:get(DevAbro.."Abro:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAbro:get(DevAbro.."Abro:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAbro:get(DevAbro.."Abro:ProNames:Num"..msg.chat_id_) or 5
...
if DevAbro:get(DevAbro.."Abro:Lock:ProNames"..msg.chat_id_) and DevAbro:get(DevAbro.."Abro:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAbro:get(DevAbro.."Abro:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAbro:srem(DevAbro..'Abro:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAbro:get(DevAbro.."Abro:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAbro:get(DevAbro.."Abro:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(UserNum) == tonumber(ProNamesTxt) or tonumber(UserNum) > tonumber(ProNamesTxt)) then 
DevAbro:sadd(DevAbro..'Abro:Muted:'..msg.chat_id_, msg.sender_user_id_)
DevAbro:del(DevAbro.."Abro:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAbro:incrby(DevAbro.."Abro:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌁︙عذرا عزيزي ↫ ["..result.first_name_.."](https://t.me/"..(result.username_ or "Dev_Prox")..")\n⌁︙عليك وضع التوحيد ↫ `"..DevAbro:get(DevAbro.."Abro:ProNames:Txt"..msg.chat_id_).."` بجانب اسمك\n⌁︙عدد المحاولات المتبقيه ↫ "..(tonumber(ProNamesTxt) - tonumber(UserNum)).."")
end
end
end
end,nil)
...
DevAbro:set(DevAbro.."Abro:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAbro:del(DevAbro.."Abro:Lock:ProNames"..msg.chat_id_)
end
end
