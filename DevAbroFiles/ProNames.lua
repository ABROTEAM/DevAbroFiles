...
if Manager(msg) then
if DevAli:get(DevAbro.."Ali:Lock:ProNames"..msg.chat_id_) then
local Txt = text:match("^وضع توحيد (.*)$") or text:match("^ضع توحيد (.*)$")
send(msg.chat_id_, msg.id_,'⌁︙تم تعيين ↫ '..Txt..' كتوحيد للمجموعه')
DevAli:set(DevAbro.."Ali:ProNames:Txt"..msg.chat_id_,Txt)
else
...
DevAli:set(DevAbro.."Ali:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAli:get(DevAbro.."Ali:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAli:get(DevAbro.."Ali:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAli:get(DevAbro.."Ali:ProNames:Num"..msg.chat_id_) or 5
...
if DevAli:get(DevAbro.."Ali:Lock:ProNames"..msg.chat_id_) and DevAli:get(DevAbro.."Ali:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAli:get(DevAbro.."Ali:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAli:srem(DevAbro..'Ali:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAli:get(DevAbro.."Ali:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAli:get(DevAbro.."Ali:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
...
DevAli:del(DevAbro.."Ali:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAli:set(DevAbro.."Ali:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAli:del(DevAbro.."Ali:Lock:ProNames"..msg.chat_id_)
end
end
