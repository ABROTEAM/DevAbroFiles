...
if DevAli:get(DevAbro.."Ali:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAli:sadd(DevAbro.."Ali:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAli:srem(DevAbro.."Ali:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAli:del(DevAbro.."Ali:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAli:smembers(DevAbro.."Ali:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAli:get(DevAbro.."Ali:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DevAbroName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DevAbroName then 
DevAbroNames = DevAli:smembers(DevAbro.."Ali:Mute:Names"..msg.chat_id_) or ""
if DevAbroNames and DevAbroNames[1] then 
for i=1,#DevAbroNames do 
if DevAbroName:match("(.*)("..DevAbroNames[i]..")(.*)") then 
...
DevAli:set(DevAbro.."Ali:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAli:del(DevAbro.."Ali:Lock:MuteNames"..msg.chat_id_)
end
end
end
