...
if result.id_ then 
local abbs = Devali:get("DevAbroTEAM:Photo"..result.id_)
if not result.profile_photo_ then 
if abbs then 
Dev_ali(msg.chat_id_, msg.id_, 1, "حذف كل صوره مضروب بوري، 😹💔", 1, 'html')
Devali:del("DevAbroTEAM:Photo"..result.id_) 
end
end
...
Dev_ali(msg.chat_id_, msg.id_, 1, abbs_text[abbs3], 1, 'html')
end  
Devali:set("DevAbroTEAM:Photo"..result.id_, result.profile_photo_.big_.persistent_id_) 
end
end
end,nil) 
end
